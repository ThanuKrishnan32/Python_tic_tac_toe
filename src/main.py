...
def select_position():
    ...
    while not (marker == 'x' or marker == 'o' or position in range(1, 10)):
        print("Provide your options with space for example x 1 or o 2")
...
def check_status():
    ...
    if matrix[0] == matrix[1] == matrix[2] == marker or matrix[3] == matrix[4] == matrix[5] == marker or matrix[6] == \
            matrix[7] == matrix[8] == marker or matrix[0] == matrix[3] == matrix[6] == marker or matrix[1] == matrix[
